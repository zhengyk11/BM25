...
if __name__ == '__main__':
    ...
    config = """
    {
        "content_file": "../data/inputs/ntcir14_test_uid_content_seg.txt",

        "doc_length_file": "../data/doc_length/doc_length_ntcir14_test.txt",
        "doc_length_file_2": "../data/doc_length/doc_length_foundation.txt",
        "doc_length_file_merge": "../data/doc_length/doc_length_ntcir14_test_merge.txt",

        "doc_freq_file": "../data/doc_freq/doc_freq_ntcir14_test.txt",
        "doc_freq_file_2": "../data/doc_freq/doc_freq_foundation.txt",
        "doc_freq_file_merge": "../data/doc_freq/doc_freq_ntcir14_test_merge.txt",

        "index_file": "../data/index/index_ntcir14_test.txt",

        "qrel_file": "../data/inputs/ntcir14_test_chn_qrels.txt",
        "qid_file": "../data/inputs/ntcir14_qid_query_seg_chn.txt",
        "queries_file": "../data/queries/queries_ntcir14_test.txt",

        "result_file": "../results/bm25_results_ntcir14_test.txt"
    }
    """
    ...
    BM25(config['doc_freq_file_merge'], config['doc_length_file_merge'], config['index_file'], config['queries_file'], config['result_file'])
